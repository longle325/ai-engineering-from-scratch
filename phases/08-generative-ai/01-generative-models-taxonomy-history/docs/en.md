...
Each family maps to a different inference-server cost curve. the production-inference framing frames LLM inference as prefill + decode; the same decomposition applies here:
