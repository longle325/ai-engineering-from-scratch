...
- [stas00, `ml-engineering/training/performance/README.md`](https://github.com/stas00/ml-engineering/blob/master/training/performance/README.md) — production-grade notes on how to actually spend the training FLOPs this lesson's budget calculus assigns (throughput, TFLOPS utilization, MFU, scaling efficiency).
- [stas00, `ml-engineering/training/hparams.md`](https://github.com/stas00/ml-engineering/blob/master/training/hparams.md) — concrete recipes for picking learning-rate, batch, and schedule given a chosen `(N, D)`.
- [stas00, `ml-engineering/compute/accelerator/README.md`](https://github.com/stas00/ml-engineering/blob/master/compute/accelerator/README.md) — the hardware side of `6ND`: peak FLOPS by chip, what counts and what doesn't, how to translate "1e23 FLOPs" into GPU-hours.
- [stas00, `ml-engineering/insights/ai-battlefield.md`](https://github.com/stas00/ml-engineering/blob/master/insights/ai-battlefield.md) — industry-reality companion that contextualizes where Chinchilla lives in 2026 planning.
- [mlabonne, LLM Course — "LLM Scientist" section "Pre-Training Models"](https://github.com/mlabonne/llm-course) — applied scaling-law framing for fine-tune and continued-pretrain budgets.
- [Karpathy, `llm.c/README.md` — reproduction notes](https://github.com/karpathy/llm.c/blob/master/README.md) — GPT-2 training cost in 2024 dollars: the scaling law made concrete at the smallest end of the frontier curve.
